...
RVO - оптимизация создания объекта созданного в точке return:

```c++
std::string makeString()
{    
    ...
    return std::string(std::to_string(anotherValue));
}
```

NRVO - оптимизация именованного объекта созданного в теле функции:
